...
class Requests {
    ...
    async transferPolysPrototype(params: ReqTypes.TransferArbitParams, id = '1'): Promise<any> {
        const requiredFields = ['amount', 'recipient', 'fee', 'sender'];
        const route = 'wallet/';
        const method = 'transferPolysPrototype';
        return BramblRequest({ route, method, id }, params, requiredFields, this);
    }
    /////////////////transferArbits////////////
    /**
    ...
    async transferArbitsPrototype(params: ReqTypes.TransferArbitParams, id = '1'): Promise<any> {
        const requiredFields = ['amount', 'sender', 'recipient', 'fee'];
        const route = 'wallet/';
        const method = 'transferArbitsPrototype';
        return BramblRequest({ route, method, id }, params, requiredFields, this);
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /////Asset Api Routes/////////////////////////////////////////////////////////////////////////////////////////////////
